...
public class DateUtil {
     ...
     * @throws IVException
     */
    public static int getTime(String date, int datePartten, int convertType) throws IVException {
    ...
    private static Calendar parseDate(String date, int rank)
        ...
        if (rank >= 3 && rank <= 7) {
            ...
            throw new IVException(CommonReturnInfo.BASE00020002);
        }
    }
     ...
     * @throws IVException
     */
    public static Calendar toDate(String date, int type) throws IVException {
        try {
            switch (type) {
            ...
            throw new IVException(CommonReturnInfo.BASE00020001, nfe);
        } catch (StringIndexOutOfBoundsException sioobe) {
            throw new IVException(CommonReturnInfo.BASE00020001, sioobe);
        } catch (RuntimeException re) {
            throw new IVException(CommonReturnInfo.BASE00000002, re);
        }
    }
