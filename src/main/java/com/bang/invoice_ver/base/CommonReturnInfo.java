package com.bang.invoice_ver.base;
...
public enum CommonReturnInfo implements IReturnInfo{
	...
	/** 业务异常，以0003开头 */
	BASE00030001("00030001", "未查询到需要更新的数据", "未查询到需要更新的数据"),//未查询到需要更新的数据
	
	/** 数据校验，以0009开头 */
	BASE00090001("00090001", "数据为空", "数据不允许为空"),//数据为空
	BASE00090002("00090002", "数据已存在", "数据已存在"),//数据已存在
	BASE00090003("00090003", "数据不存在", "数据不存在"),//数据不存在
	BASE00090004("00090004", "数据完整性校验失败", "系统异常，请联系管理员"),//数据完整性校验失败
	BASE00090005("00090005", "传入数据为空", "传入数据为空");//传入数据为空
